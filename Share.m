...
-(IBAction)ShareThisAppViaMail:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
        ...
        [SendMailcontroller setSubject:@"Learn, revise and test yourself on the go – GCSE Chemistry App"];
        
        [SendMailcontroller setMessageBody:[NSString stringWithFormat:@"Checkout the FREE LearnersCloud Chemistry App loaded with thousands of test questions and answers. To download this App for iPad<a href=http://itunes.apple.com/us/app/gcse-chemistry-questions./id421349385?ls=1&mt=8> click here</a>. For iPhone<a href=http://itunes.apple.com/us/app/gcse-chemistry-questions/id423199816?ls=1&mt=8>  click here</a>. Or search LearnersCloud on your device’s App store. Don’t forget to come and see us for loads more: www.Learnerscloud.com"] isHTML:YES];
...
-(void)ConnectToFaceBook {
    ...
    facebook = [[Facebook alloc] initWithAppId:@"472786916082850" andDelegate:self];
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                  @"I’ve just started using a new App for GCSE Chemistry! Thousands of test questions and answers, plus you can record how well you do and share it. You should check it out, just search LearnersCloud in your device’s App store.",  @"message",nil];
...
-(void)Twit {
    ...
    {
        NSString *UrlString = @"http://itunes.apple.com/us/app/gcse-chemistry-questions/id423199816?ls=1&mt=8";
        
        TWTweetComposeViewController *tweetSheet = [[TWTweetComposeViewController alloc] init];
        [tweetSheet setInitialText:@"Checkout @LearnersCloud #GCSE App for Chemistry - Learn, revise and test yourself on the go"];
