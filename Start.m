...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (tableView.tag == 1) {
        ...
        NSString *HeaderImagePath = [[NSBundle mainBundle] pathForResource:@"EQ_chemistry_160x78" ofType:@"png"];
...
- (void)reviewPressed {
    ...
    // Report to  analytics
    NSError *error;
    if (![[GANTracker sharedTracker] trackEvent:@"User Sent to Review Chemistry Question iPhone at app store"
                                         action:@"User Sent to Review Chemistry Question iPhone at app store"
                                          label:@"User Sent to Review Chemistry Question iPhone at app store"
                                          value:1
                                      withError:&error]) {
    ...
    NSString *str = @"https://userpub.itunes.apple.com/WebObjects/MZUserPublishing.woa/wa/addUserReview?id=423199816&type=Purple+Software"; 
