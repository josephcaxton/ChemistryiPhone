...
-(IBAction)ReportProblem:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
		...
		[SendMailcontroller setSubject:[NSString stringWithFormat:@"Ref %@ problem chemistry question detected on IPhone/IPod",[[NSString stringWithFormat:@"%@",QItem_View.Question] stringByDeletingPathExtension]]];
...
-(void)loadDocument:(NSString*)documentName inView:(UIWebView*)webView{
	...
	//[[NSUserDefaults standardUserDefaults] setInteger:0 forKey:@"WebKitCacheModelPreferenceKey"];  // To remove latter 
