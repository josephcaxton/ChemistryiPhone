	...
	switch([AccessLevel intValue])
	{
		case 1:   
			...
			switch (myTag) {
				...
				/*case 3:
                {
					SKPayment *payment3 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.750"];
				...
				case 4:
                {
					SKPayment *payment4 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.1000"];
					[[SKPaymentQueue defaultQueue] addPayment:payment4];
					break;
                }
                case 5:
		...
		case 2: 
			...
			switch (myTag) {
				...
				/*case 3:
                {
					SKPayment *payment3 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.250To1040"];
					[[SKPaymentQueue defaultQueue] addPayment:payment3];
		...
		/*case 3:
			...
			switch (myTag) {
				case 1:
                {
					SKPayment *payment1 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.500To750"];
				...
				case 2:
                {
					SKPayment *payment2 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.500To1040"];
		...
		case 4:
			switch (myTag) {
				case 1:
                {
					SKPayment *payment1 = [SKPayment paymentWithProductIdentifier:@"com.LearnersCloud.iEvaluatorforIPhone.chemistry.750To1040"];
					[[SKPaymentQueue defaultQueue] addPayment:payment1];
					break;
                }
                case 2:
